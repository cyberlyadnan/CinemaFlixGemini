      ...
      <div className="container mx-auto">
        ...
        <div className="space-y-4 text-center">
          {faqs.map((faq, index) => (
            <div key={index}>
              <button
                className="w-8/12 text-left py-4 px-6 bg-[rgb(45,45,45)] focus:outline-none focus:bg-[rgb(65,65,65)] hover:bg-[rgb(65,65,65)]"
              ...
              {openIndex === index && (
                <div className="w-8/12 mx-auto bg-[rgb(60,60,60)] py-4 px-6 mt-2">
